...
public class CssXpathExamples {
    void cssXpath(){
        ...
        // </div>
        $(" inputtext .login_form_input_box").setValue("1"); // надо ставить пробел если 2 разных элемента
        $(".inputtext").$(".login_form_input_box").setValue("1");
        ...
        $(withText("lo, qa.g"));
        $x("//*[text()='Hello, qa.guru!']"); //wrong xpath
        $x("//*[contains(text(),'Hello, qa.guru!')]"); // good xpath
    }
}
